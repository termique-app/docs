...
By default, requests go to the Termique API backend, which uses Cloudflare Workers AI. No API key required. Your conversation is processed on the backend and not stored.
